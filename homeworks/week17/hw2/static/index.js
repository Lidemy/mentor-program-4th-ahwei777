//  將固定網址及文字設為變數
const API_URL = 'https://obscure-refuge-93288.herokuapp.com/lotteries/';
...
document.querySelector('.lottery-btn').addEventListener('click', () => {
  getPrize((err, json) => {
    ...
    //  依據 name 更換獎項名稱
    document.querySelector('.lottery-result__title').innerText = name;
    //  依據 content 更換獎項說明
    document.querySelector('.lottery-result__content').innerText = content;
    //  依據 imageURL 更換背景
